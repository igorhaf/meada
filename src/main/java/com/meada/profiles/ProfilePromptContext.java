...
public class ProfilePromptContext {
    ...
    private final com.meada.profiles.dental.DentalContextCache dentalContextCache;
    private final com.meada.profiles.salon.SalonContextCache salonContextCache;
    private final com.meada.profiles.pousada.PousadaContextCache pousadaContextCache;
    private final com.meada.profiles.academia.AcademiaContextCache academiaContextCache;
    private final com.meada.profiles.pet.PetContextCache petContextCache;
    private final com.meada.profiles.oficina.OficinaContextCache oficinaContextCache;
    private final com.meada.profiles.nutri.NutriContextCache nutriContextCache;
    private final com.meada.profiles.barbearia.BarberContextCache barberContextCache;
    private final com.meada.profiles.eventos.EventosContextCache eventosContextCache;
    private final com.meada.profiles.estetica.EsteticaContextCache esteticaContextCache;
    private final com.meada.profiles.comida.ComidaMenuCache comidaMenuCache;
    private final com.meada.profiles.floricultura.FloriculturaCatalogCache floriculturaCatalogCache;
    private final com.meada.profiles.pizzaria.PizzariaMenuCache pizzariaMenuCache;
    private final com.meada.profiles.adega.AdegaMenuCache adegaMenuCache;
    private final com.meada.profiles.escola.EscolaContextCache escolaContextCache;
    private final com.meada.profiles.atelie.AtelieContextCache atelieContextCache;
    private final com.meada.profiles.casamento.CasamentoContextCache casamentoContextCache;
    private final com.meada.profiles.concessionaria.ConcessionariaContextCache concessionariaContextCache;
    private final com.meada.profiles.lavanderia.LavanderiaCatalogCache lavanderiaCatalogCache;
    private final com.meada.profiles.dermatologia.DermatologiaContextCache dermatologiaContextCache;
    private final com.meada.profiles.fotografia.FotografiaContextCache fotografiaContextCache;
    private final com.meada.profiles.cursos.CursosContextCache cursosContextCache;
    private final com.meada.profiles.lingerie.LingerieMenuCache lingerieMenuCache;
    private final com.meada.profiles.modainfantil.ModaInfantilMenuCache modaInfantilMenuCache;
    private final com.meada.profiles.las.LasMenuCache lasMenuCache;
    private final com.meada.profiles.padaria.PadariaMenuCache padariaMenuCache;
    private final com.meada.profiles.otica.OticaContextCache oticaContextCache;
    private final com.meada.profiles.papelaria.PapelariaCatalogCache papelariaCatalogCache;
    private final com.meada.profiles.viagens.ViagensContextCache viagensContextCache;
    private final com.meada.profiles.suplementos.SuplementosMenuCache suplementosMenuCache;
    ...
    public ProfilePromptContext(SushiMenuCache sushiMenuCache,
                                ...
                                com.meada.profiles.dental.DentalContextCache dentalContextCache,
                                com.meada.profiles.salon.SalonContextCache salonContextCache,
                                com.meada.profiles.pousada.PousadaContextCache pousadaContextCache,
                                com.meada.profiles.academia.AcademiaContextCache academiaContextCache,
                                com.meada.profiles.pet.PetContextCache petContextCache,
                                com.meada.profiles.oficina.OficinaContextCache oficinaContextCache,
                                com.meada.profiles.nutri.NutriContextCache nutriContextCache,
                                com.meada.profiles.barbearia.BarberContextCache barberContextCache,
                                com.meada.profiles.eventos.EventosContextCache eventosContextCache,
                                com.meada.profiles.estetica.EsteticaContextCache esteticaContextCache,
                                com.meada.profiles.comida.ComidaMenuCache comidaMenuCache,
                                com.meada.profiles.floricultura.FloriculturaCatalogCache floriculturaCatalogCache,
                                com.meada.profiles.pizzaria.PizzariaMenuCache pizzariaMenuCache,
                                com.meada.profiles.adega.AdegaMenuCache adegaMenuCache,
                                com.meada.profiles.escola.EscolaContextCache escolaContextCache,
                                com.meada.profiles.atelie.AtelieContextCache atelieContextCache,
                                com.meada.profiles.casamento.CasamentoContextCache casamentoContextCache,
                                com.meada.profiles.concessionaria.ConcessionariaContextCache concessionariaContextCache,
                                com.meada.profiles.lavanderia.LavanderiaCatalogCache lavanderiaCatalogCache,
                                com.meada.profiles.dermatologia.DermatologiaContextCache dermatologiaContextCache,
                                com.meada.profiles.fotografia.FotografiaContextCache fotografiaContextCache,
                                com.meada.profiles.cursos.CursosContextCache cursosContextCache,
                                com.meada.profiles.lingerie.LingerieMenuCache lingerieMenuCache,
                                com.meada.profiles.modainfantil.ModaInfantilMenuCache modaInfantilMenuCache,
                                com.meada.profiles.las.LasMenuCache lasMenuCache,
                                com.meada.profiles.padaria.PadariaMenuCache padariaMenuCache,
                                com.meada.profiles.otica.OticaContextCache oticaContextCache,
                                com.meada.profiles.papelaria.PapelariaCatalogCache papelariaCatalogCache,
                                com.meada.profiles.viagens.ViagensContextCache viagensContextCache,
                                com.meada.profiles.suplementos.SuplementosMenuCache suplementosMenuCache,
