...
import com.meada.profiles.salon.professionals.SalonProfessionalService.ProfessionalInUseException;
import com.meada.profiles.salon.professionals.SalonProfessionalService.ProfessionalNotFoundException;
...
/**
 * Profissionais do tenant salon (camada 7.5). TENANT + perfil 'salon' only.
 */
@RestController
public class SalonProfessionalController {

    private final SalonProfessionalService service;
    private final SalonProfileGuard profileGuard;

    public SalonProfessionalController(SalonProfessionalService service, SalonProfileGuard profileGuard) {
    ...
    @GetMapping("/api/salon/professionals")
    ...
    @GetMapping("/api/salon/professionals/{id}")
    ...
    @PostMapping("/api/salon/professionals")
    public ResponseEntity<Object> create(
        ...
        SalonProfessional created = service.create(companyId, user.userId(), req.name(), req.specialty(), req.notes());
        return ResponseEntity.status(201).body(created);
    }

    @PatchMapping("/api/salon/professionals/{id}")
    ...
    @PatchMapping("/api/salon/professionals/{id}/toggle")
    ...
    @DeleteMapping("/api/salon/professionals/{id}")
