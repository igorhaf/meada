...
/**
 * Config de fidelidade por contagem do tenant adega (camada 8.9, backlog #2 — clone do chassi
 ...
 * (enabled=false).
 */
public record AdegaLoyaltyConfig(
    UUID companyId,
    boolean enabled,
    int thresholdOrders,
    String rewardKind,
    ...
    public static AdegaLoyaltyConfig defaults(UUID companyId) {
        return new AdegaLoyaltyConfig(companyId, false, 10, "percent", 0);
    }
}
