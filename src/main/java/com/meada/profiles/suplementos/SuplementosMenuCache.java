...
import com.meada.profiles.suplementos.catalog.SupProductRepository;
 ...
 * {@link com.meada.profiles.lingerie.LingerieMenuCache} (Caffeine TTL 60s, chassi de varejo)
 * — o {@link com.meada.profiles.suplementos.catalog.SupProductService} chama
