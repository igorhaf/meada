...
import com.meada.profiles.pet.config.PetConfigService.InvalidHoursException;
...
/** Config do pet (camada 7.8). TENANT + perfil 'pet' only. GET (fallback) + PUT. */
@RestController
public class PetConfigController {

    private final PetConfigService service;
    private final PetProfileGuard profileGuard;

    public PetConfigController(PetConfigService service, PetProfileGuard profileGuard) {
