...
import com.meada.whatsapp.profiles.sushi.coupons.SushiCouponService.CouponNotFoundException;
import com.meada.whatsapp.profiles.sushi.coupons.SushiCouponService.DuplicateCouponException;
import com.meada.whatsapp.profiles.sushi.coupons.SushiCouponService.InvalidCouponException;
...
/**
 * Cupons de desconto do tenant sushi (camada 7.1 / sushi funcional). TENANT + perfil 'sushi' only.
 * CRUD do catálogo de cupons; a aplicação acontece na criação do pedido. Sob {@code /api/sushi/**}.
 */
@RestController
public class SushiCouponController {

    private final SushiCouponService service;
    private final SushiProfileGuard profileGuard;

    public SushiCouponController(SushiCouponService service, SushiProfileGuard profileGuard) {
    ...
    @GetMapping("/api/sushi/coupons/{id}")
    ...
    @PatchMapping("/api/sushi/coupons/{id}")
    ...
    @PatchMapping("/api/sushi/coupons/{id}/toggle")
    ...
    @DeleteMapping("/api/sushi/coupons/{id}")
