...
import com.meada.whatsapp.profiles.pizzaria.PizzariaProfileGuard;
import com.meada.whatsapp.profiles.pizzaria.PizzariaProfileGuard.WrongProfileException;
import com.meada.whatsapp.profiles.pizzaria.menu.PizzariaMenuService.InvalidCategoryException;
import com.meada.whatsapp.profiles.pizzaria.menu.PizzariaMenuService.MenuItemInUseException;
import com.meada.whatsapp.profiles.pizzaria.menu.PizzariaMenuService.MenuItemNotFoundException;
import com.meada.whatsapp.profiles.pizzaria.menu.PizzariaMenuService.OptionNotFoundException;
...
/**
 * Cardápio do tenant pizzaria (camada 8.4). Clone de
 * {@link com.meada.whatsapp.profiles.sushi.menu.SushiMenuController} + as rotas aninhadas de OPÇÃO
 * (ESCAPADA 2). TENANT + perfil 'pizzaria' only — {@link PizzariaProfileGuard} rejeita 403
 * forbidden_wrong_profile qualquer outro perfil. Sob {@code /api/pizzaria/menu/**}.
 */
@RestController
public class PizzariaMenuController {

    private final PizzariaMenuService service;
    private final PizzariaProfileGuard profileGuard;

    public PizzariaMenuController(PizzariaMenuService service, PizzariaProfileGuard profileGuard) {
    ...
    @GetMapping("/api/pizzaria/menu/{id}")
    ...
    // ---- PATCH edita --------------------------------------------------------
    @PatchMapping("/api/pizzaria/menu/{id}")
    ...
    // ---- PATCH toggle -------------------------------------------------------
    @PatchMapping("/api/pizzaria/menu/{id}/toggle")
    ...
    // ---- DELETE -------------------------------------------------------------
    @DeleteMapping("/api/pizzaria/menu/{id}")
    ...
    // ---- GET lista de opções ------------------------------------------------
    @GetMapping("/api/pizzaria/menu/{itemId}/options")
    ...
    // ---- POST cria opção ----------------------------------------------------
    @PostMapping("/api/pizzaria/menu/{itemId}/options")
    ...
    // ---- PATCH edita opção --------------------------------------------------
    @PatchMapping("/api/pizzaria/menu/{itemId}/options/{optionId}")
    ...
    // ---- PATCH toggle opção -------------------------------------------------
    @PatchMapping("/api/pizzaria/menu/{itemId}/options/{optionId}/toggle")
    ...
    // ---- DELETE opção -------------------------------------------------------
    @DeleteMapping("/api/pizzaria/menu/{itemId}/options/{optionId}")
