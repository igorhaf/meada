...
import com.meada.whatsapp.profiles.nutri.config.NutriConfigService.InvalidHoursException;
...
/** Config do nutri (camada 8.0). TENANT + perfil 'nutri' only. GET (fallback) + PUT. */
@RestController
public class NutriConfigController {

    private final NutriConfigService service;
    private final NutriProfileGuard profileGuard;

    public NutriConfigController(NutriConfigService service, NutriProfileGuard profileGuard) {
