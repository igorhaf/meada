...
import com.meada.whatsapp.profiles.eventos.planners.EventPlannerService.PlannerInUseException;
import com.meada.whatsapp.profiles.eventos.planners.EventPlannerService.PlannerNotFoundException;
...
/** Cerimonialistas do tenant eventos (camada 8.2). TENANT + perfil 'eventos' only. */
@RestController
public class EventPlannerController {
    ...
    public EventPlannerController(EventPlannerService service, EventosProfileGuard profileGuard) {
    ...
    @GetMapping("/api/eventos/planners")
    ...
    @GetMapping("/api/eventos/planners/{id}")
    ...
    @PostMapping("/api/eventos/planners")
    ...
    @PatchMapping("/api/eventos/planners/{id}")
    ...
    @PatchMapping("/api/eventos/planners/{id}/toggle")
    ...
    @DeleteMapping("/api/eventos/planners/{id}")
