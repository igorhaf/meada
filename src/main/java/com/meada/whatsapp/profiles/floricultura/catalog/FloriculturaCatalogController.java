...
import com.meada.whatsapp.profiles.floricultura.FloriculturaProfileGuard;
import com.meada.whatsapp.profiles.floricultura.FloriculturaProfileGuard.WrongProfileException;
import com.meada.whatsapp.profiles.floricultura.catalog.FloriculturaCatalogService.InvalidCategoryException;
import com.meada.whatsapp.profiles.floricultura.catalog.FloriculturaCatalogService.CatalogItemInUseException;
import com.meada.whatsapp.profiles.floricultura.catalog.FloriculturaCatalogService.CatalogItemNotFoundException;
import com.meada.whatsapp.profiles.floricultura.catalog.FloriculturaCatalogService.OptionNotFoundException;
...
/**
 * Cardápio do tenant floricultura (camada 8.4). Clone de
 * {@link com.meada.whatsapp.profiles.sushi.catalog.SushiCatalogController} + as rotas aninhadas de OPÇÃO
 * (ESCAPADA 2). TENANT + perfil 'floricultura' only — {@link FloriculturaProfileGuard} rejeita 403
 * forbidden_wrong_profile qualquer outro perfil. Sob {@code /api/floricultura/catalog/**}.
 */
@RestController
public class FloriculturaCatalogController {

    private final FloriculturaCatalogService service;
    private final FloriculturaProfileGuard profileGuard;

    public FloriculturaCatalogController(FloriculturaCatalogService service, FloriculturaProfileGuard profileGuard) {
    ...
    // ---- GET lista ----------------------------------------------------------
    @GetMapping("/api/floricultura/catalog")
    ...
    @GetMapping("/api/floricultura/catalog/{id}")
    ...
    // ---- POST cria ----------------------------------------------------------
    @PostMapping("/api/floricultura/catalog")
    ...
    // ---- PATCH edita --------------------------------------------------------
    @PatchMapping("/api/floricultura/catalog/{id}")
    ...
    // ---- PATCH toggle -------------------------------------------------------
    @PatchMapping("/api/floricultura/catalog/{id}/toggle")
    ...
    // ---- DELETE -------------------------------------------------------------
    @DeleteMapping("/api/floricultura/catalog/{id}")
    ...
    // ---- GET lista de opções ------------------------------------------------
    @GetMapping("/api/floricultura/catalog/{itemId}/options")
    ...
    // ---- POST cria opção ----------------------------------------------------
    @PostMapping("/api/floricultura/catalog/{itemId}/options")
    ...
    // ---- PATCH edita opção --------------------------------------------------
    @PatchMapping("/api/floricultura/catalog/{itemId}/options/{optionId}")
    ...
    // ---- PATCH toggle opção -------------------------------------------------
    @PatchMapping("/api/floricultura/catalog/{itemId}/options/{optionId}/toggle")
    ...
    // ---- DELETE opção -------------------------------------------------------
    @DeleteMapping("/api/floricultura/catalog/{itemId}/options/{optionId}")
