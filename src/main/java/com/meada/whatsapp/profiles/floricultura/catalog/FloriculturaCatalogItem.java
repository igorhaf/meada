 ...
 * {@link com.meada.whatsapp.profiles.sushi.catalog.SushiCatalogItem} + a lista de {@code options}
 * (ESCAPADA 2: modifiers). priceCents em centavos é o preço BASE (sem opções); category é o id
 * estável de {@link com.meada.whatsapp.profiles.floricultura.FloriculturaCategory}.
 */
