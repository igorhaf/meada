 ...
 * {@link com.meada.whatsapp.profiles.lingerie.catalog.LingerieProduct}: {@code category} (id estável
 * de {@link com.meada.whatsapp.profiles.modainfantil.ModaInfantilCategory}) + {@code basePriceCents}
