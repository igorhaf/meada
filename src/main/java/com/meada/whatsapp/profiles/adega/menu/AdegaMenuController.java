...
import com.meada.whatsapp.profiles.adega.AdegaProfileGuard;
import com.meada.whatsapp.profiles.adega.AdegaProfileGuard.WrongProfileException;
import com.meada.whatsapp.profiles.adega.menu.AdegaMenuService.InvalidCategoryException;
import com.meada.whatsapp.profiles.adega.menu.AdegaMenuService.MenuItemInUseException;
import com.meada.whatsapp.profiles.adega.menu.AdegaMenuService.MenuItemNotFoundException;
import com.meada.whatsapp.profiles.adega.menu.AdegaMenuService.OptionNotFoundException;
...
/**
 * Cardápio do tenant adega (camada 8.4). Clone de
 * {@link com.meada.whatsapp.profiles.sushi.menu.SushiMenuController} + as rotas aninhadas de OPÇÃO
 * (ESCAPADA 2). TENANT + perfil 'adega' only — {@link AdegaProfileGuard} rejeita 403
 * forbidden_wrong_profile qualquer outro perfil. Sob {@code /api/adega/menu/**}.
 */
@RestController
public class AdegaMenuController {

    private final AdegaMenuService service;
    private final AdegaProfileGuard profileGuard;

    public AdegaMenuController(AdegaMenuService service, AdegaProfileGuard profileGuard) {
    ...
    // ---- PATCH edita --------------------------------------------------------
    @PatchMapping("/api/adega/menu/{id}")
    ...
    // ---- PATCH toggle -------------------------------------------------------
    @PatchMapping("/api/adega/menu/{id}/toggle")
    ...
    // ---- DELETE -------------------------------------------------------------
    @DeleteMapping("/api/adega/menu/{id}")
    ...
    // ---- GET lista de opções ------------------------------------------------
    @GetMapping("/api/adega/menu/{itemId}/options")
    ...
    // ---- POST cria opção ----------------------------------------------------
    @PostMapping("/api/adega/menu/{itemId}/options")
    ...
    // ---- PATCH edita opção --------------------------------------------------
    @PatchMapping("/api/adega/menu/{itemId}/options/{optionId}")
    ...
    // ---- PATCH toggle opção -------------------------------------------------
    @PatchMapping("/api/adega/menu/{itemId}/options/{optionId}/toggle")
    ...
    // ---- DELETE opção -------------------------------------------------------
    @DeleteMapping("/api/adega/menu/{itemId}/options/{optionId}")
