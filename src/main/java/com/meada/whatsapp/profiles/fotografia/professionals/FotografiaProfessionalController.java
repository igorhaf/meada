...
import com.meada.whatsapp.profiles.fotografia.professionals.FotografiaProfessionalService.ProfessionalInUseException;
import com.meada.whatsapp.profiles.fotografia.professionals.FotografiaProfessionalService.ProfessionalNotFoundException;
...
/** Fotógrafos do tenant fotografia (camada 8.16). TENANT + perfil 'fotografia' only. Clone do DermatologiaProfessionalController. */
@RestController
public class FotografiaProfessionalController {

    private final FotografiaProfessionalService service;
    private final FotografiaProfileGuard profileGuard;

    public FotografiaProfessionalController(FotografiaProfessionalService service, FotografiaProfileGuard profileGuard) {
    ...
    @GetMapping("/api/fotografia/professionals")
    ...
    @GetMapping("/api/fotografia/professionals/{id}")
    ...
    @PostMapping("/api/fotografia/professionals")
    ...
    @PatchMapping("/api/fotografia/professionals/{id}")
    ...
    @PatchMapping("/api/fotografia/professionals/{id}/toggle")
    ...
    @DeleteMapping("/api/fotografia/professionals/{id}")
