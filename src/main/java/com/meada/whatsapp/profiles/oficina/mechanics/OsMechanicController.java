...
import com.meada.whatsapp.profiles.oficina.mechanics.OsMechanicService.MechanicInUseException;
import com.meada.whatsapp.profiles.oficina.mechanics.OsMechanicService.MechanicNotFoundException;
...
/** Mecânicos do tenant oficina (camada 7.9). TENANT + perfil 'oficina' only. */
@RestController
public class OsMechanicController {

    private final OsMechanicService service;
    private final OficinaProfileGuard profileGuard;

    public OsMechanicController(OsMechanicService service, OficinaProfileGuard profileGuard) {
    ...
    @GetMapping("/api/oficina/mechanics")
    ...
    @GetMapping("/api/oficina/mechanics/{id}")
    public ResponseEntity<Object> detail(
        ...
        return service.get(companyId, id)
            ...
            .orElseGet(() -> error(404, "Not Found", "mechanic_not_found"));
    }

    @PostMapping("/api/oficina/mechanics")
    ...
    @PatchMapping("/api/oficina/mechanics/{id}")
    ...
    @PatchMapping("/api/oficina/mechanics/{id}/toggle")
    ...
    @DeleteMapping("/api/oficina/mechanics/{id}")
    public ResponseEntity<Object> delete(
        ...
        try {
            ...
            return error(404, "Not Found", "mechanic_not_found");
        } catch (MechanicInUseException e) {
            return error(409, "Conflict", "mechanic_in_use");
        }
    }
}
