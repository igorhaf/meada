 ...
 * {@link com.meada.whatsapp.profiles.adega.menu.AdegaMenuOption}: em vez de um delta de preço, cada
 ...
 * criação. {@code size} é validado contra {@link com.meada.whatsapp.profiles.lingerie.LingerieSize};
