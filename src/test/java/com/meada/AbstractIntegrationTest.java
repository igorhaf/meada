...
public abstract class AbstractIntegrationTest {
    ...
    private static final String[] SCRIPTS = {
        ...
        "db/migrations/87_viagens_onda1.sql",
        "db/migrations/88_sushi_onda2.sql",
        "db/migrations/89_suplementos_onda1.sql",
        "db/migrations/90_salon_onda1.sql",
        "db/migrations/91_restaurant_onda1.sql",
        ...
        "db/migrations/97_otica_onda1.sql",
        "db/migrations/98_oficina_onda1.sql",
        "db/migrations/99_nutri_onda1.sql",
        "db/migrations/100_moda_infantil_onda1.sql",
        "db/migrations/101_lingerie_onda1.sql",
        "db/migrations/102_legal_onda1.sql"
    };
