...
/**
 * Configurações do consultório de dermatologia (camada 8.11): horário de funcionamento + intervalo
 * entre consultas. A duração de cada consulta vem do TIPO de atendimento (não daqui). Mudanças
 * afetam consultas FUTURAS.
 */
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Horário de funcionamento e intervalo entre consultas. A duração de cada consulta vem do tipo de atendimento."
      />
