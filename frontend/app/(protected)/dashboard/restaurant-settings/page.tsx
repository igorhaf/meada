...
/**
 * Configurações de reservas do MesaBot (camada 7.3): duração da reserva, buffer e horário de
 * funcionamento. Mudanças afetam reservas FUTURAS (a duração é snapshotada em cada reserva).
 */
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Duração da reserva, intervalo entre reservas e horário de funcionamento."
      />
