...
export default function EventosPlannersPage() {
  ...
  const saveMutation = useMutation({
    mutationFn: () => {
      ...
      return createPlanner({ name: form.name, specialty: form.specialty || null, notes: form.notes || null })
    },
    onSuccess: () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title={editing ? 'Editar cerimonialista' : 'Novo cerimonialista'} size="md">
