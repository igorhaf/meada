          ...
          <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); saveMutation.mutate() }}>
            <Section title="Identidade da agência">
              <div className="space-y-4">
                <div>
                  <label className="mb-1 block text-xs font-medium text-muted-foreground">Nome da agência</label>
            ...
            <p className="text-xs text-muted-foreground">
              A agência trabalha por <strong>proposta</strong> (cotação + itinerário), não por agendamento
              de horário — por isso não há configuração de horário aqui.
            </p>
