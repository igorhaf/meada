    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Desktop Nav Links */}
          <div className="meada-nav-links" style={{ alignItems: 'center', gap: '2rem' }}>
            {navLinks.map((link) => {
          ...
          >
            <span style={{
              ...
              background: '#fff', borderRadius: '2px', transition: 'all 0.25s',
      ...
      {/* Mobile Menu */}
      <div className={`meada-mobile-nav${mobileOpen ? ' open' : ''}`}>
        {navLinks.map((link) => {
          const isActive = pathname === link.href;
          return (
            <Link
