        ...
        >
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              {[
                {
                  href: 'https://instagram.com/meadaagencia',
                  label: 'Instagram',
                ...
                {
                  href: 'https://wa.me/5581995489984',
                  label: 'WhatsApp',
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.7rem' }}>
              ...
              <li>
                <a href="https://wa.me/5581995489984" target="_blank" rel="noopener noreferrer"
                  style={{ color: 'rgba(255,255,255,0.4)', textDecoration: 'none', fontSize: '14px', transition: 'color 0.2s ease' }}
              ...
              <li>
                <a href="https://instagram.com/meadaagencia" target="_blank" rel="noopener noreferrer"
                  style={{ color: 'rgba(255,255,255,0.4)', textDecoration: 'none', fontSize: '14px', transition: 'color 0.2s ease' }}
