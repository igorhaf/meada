...
export const PROFILES = [
  ...
  { id: 'floricultura', productName: 'Floricultura', subdomain: 'floricultura', defaultPaletteId: 'rosa-po' },
  ...
  { id: 'casamento', productName: 'Casamento', subdomain: 'casamento', defaultPaletteId: 'trigo' },
  { id: 'concessionaria', productName: 'Concessionária', subdomain: 'concessionaria', defaultPaletteId: 'meia-noite' },
  { id: 'lavanderia', productName: 'Lavanderia', subdomain: 'lavanderia', defaultPaletteId: 'oceano' },
  { id: 'dermatologia', productName: 'Dermatologia', subdomain: 'dermatologia', defaultPaletteId: 'teal' },
  ...
  { id: 'las', productName: 'Lãs', subdomain: 'las', defaultPaletteId: 'ferrugem' },
  { id: 'padaria', productName: 'Padaria', subdomain: 'padaria', defaultPaletteId: 'abobora' },
  { id: 'otica', productName: 'Ótica', subdomain: 'otica', defaultPaletteId: 'ardosia' },
  { id: 'papelaria', productName: 'Papelaria', subdomain: 'papelaria', defaultPaletteId: 'lavanda' },
  { id: 'viagens', productName: 'Viagens', subdomain: 'viagens', defaultPaletteId: 'floresta' },
  { id: 'suplementos', productName: 'Suplementos', subdomain: 'suplementos', defaultPaletteId: 'eucalipto' },
] as const
