...
export function listAppointments(
  opts: {
    status?: string; dateFrom?: string; dateTo?: string; barberId?: string
...
export function createAppointment(input: CreateAppointmentInput): Promise<Appointment> {
  return apiFetch<Appointment>('/api/barbearia/appointments', { method: 'POST', body: JSON.stringify(input) })
}

export function updateAppointmentStatus(id: string, newStatus: BarberAppointmentStatusId): Promise<Appointment> {
