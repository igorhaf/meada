...
@section('description', \Illuminate\Support\Str::limit(strip_tags((string) $page->body), 150))
    ...
    <div class="container-doce py-10">
        ...
        <div class="mx-auto max-w-3xl">
            ...
            <div class="mt-10 rounded-2xl bg-brand-50 p-6 text-sm text-brand-800">
                Ainda com dúvidas? <a href="{{ route('contact.show') }}" class="font-semibold underline">Fale com a gente</a> ou
                <a href="{{ route('custom-orders.create') }}" class="font-semibold underline">faça uma encomenda 🎂</a>.
            </div>
        </div>
    </div>
@endsection
