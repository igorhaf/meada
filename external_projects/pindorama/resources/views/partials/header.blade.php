            ...
            <div class="flex-1">
                ...
                >
                    ...
                    <form action="{{ route('search') }}" method="GET" class="flex overflow-hidden rounded-xl bg-white">
                        <input name="q" value="{{ request('q') }}" placeholder="Busque por terapias, terapeutas ou práticas…" class="w-full border-0 px-4 py-3 text-sm text-neutral-800 focus:outline-none">
