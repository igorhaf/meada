...
class SiteSetting extends Model
{
    ...
    public static function current(): self
    {
        return static::$current ??= static::query()->first() ?? new static([
            'site_name' => 'Pindorama',
            'tagline' => 'Marketplace de terapias integrativas',
            'about' => 'Encontre terapeutas de práticas integrativas e agende sua sessão: acupuntura, reiki, ayurveda, massoterapia e mais.',
        ]);
    }
