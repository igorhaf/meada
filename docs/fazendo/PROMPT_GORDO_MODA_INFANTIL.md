>>> SLOT ATRIBUÍDO (ver docs/prompts-gordos/README.md — tem precedência sobre qualquer "provisório"
...
ESCAPADA ESTRUTURAL nova: GRADE DE VARIANTES DE PRODUTO COM ESTOQUE POR VARIANTE.
  ...
  é a LINGERIE (se PROMPT_GORDO_LINGERIE.md existir no diretório no arranque, LEIA-O e espelhe o modelo
