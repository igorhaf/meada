...
logo o slot NATURAL seria 51_adega. MAS há OUTROS drafts disputando o slot (PROMPT_GORDO_CASAMENTO.md
e PROMPT_GORDO_PADARIA.md na raiz, além do pizzaria) — qualquer um pode ser executado antes desta SM.
