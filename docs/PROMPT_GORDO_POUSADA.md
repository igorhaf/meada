>>> JÁ IMPLEMENTADO — perfil pousada, camada 7.6, migration 35_pousada.sql. Prompt gordo
...
retroativa do prompt gordo que teria gerado o que existe hoje no código. Toda seção reflete o
