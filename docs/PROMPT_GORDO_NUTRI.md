>>> JÁ IMPLEMENTADO — perfil nutri, camada 8.0, migration 39_nutri.sql. Prompt gordo RETROATIVO,
...
formato T5 ("prompt gordo"), o que de fato foi construído — não é um plano a executar. DÉCIMO perfil
