>>> JÁ IMPLEMENTADO — perfil comida, camada 8.4, migration 47_comida.sql. Prompt gordo RETROATIVO,
...
Este documento é a reconstrução RETROATIVA (formato T5) do prompt gordo que teria originado o perfil
...
abaixo descreve o REAL (não a intenção), espelhando o estilo de `docs/prompts-gordos/
